...
func TestHeader(t *testing.T) {
	var cases = []struct {
		...
		{[]byte{0x49, 0x44, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{}, "invalid id3 version"},
		{[]byte{0x49, 0x44, 0x33, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{}, "invalid id3 version"},
		{[]byte{0x49, 0x44, 0x33, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{}, "invalid id3 version"},
		{[]byte{0x49, 0x44, 0x33, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_3, Size: 0}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_4, Size: 0}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_4, Size: 0, Flags: TagFlagUnsync}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_4, Size: 4, Padding: 4}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_4, Size: 4, Padding: 4}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_4, Size: 5, Padding: 5}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00}, Tag{Version: Version2_3, Size: 5, Padding: 5}, ""},
		{[]byte{0x49, 0x44, 0x33, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00}, Tag{}, "unexpected EOF"},
	...
	for i, c := range cases {
		...
		case tag.Padding != c.tag.Padding:
			t.Errorf("header case %v:\n  invalid padding: got %v, expected %v\n",
				i, tag.Padding, c.tag.Padding)
		}
	}
}
